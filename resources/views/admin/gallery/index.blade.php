...
<div class="container">
    <div class="row">
        <div class="col-md-12">
			<a class="btn btn-default" href="gallery/create" role="button">Create</a>
				...
				<tbody>
					@foreach($list as $item)
						<tr>
							...
							<td>
							<a class="btn btn-success" href="gallery/{{ $item->id }}" role="button">show</a>
							<a class="btn btn-primary" href="gallery/{{ $item->id }}/edit" role="button">Edit</a> 
							<a class="btn btn-danger" href="gallery/destroy/{{ $item->id }}" role="button">Delete</a>
