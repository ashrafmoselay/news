...
<div class="container">
    <div class="row">
        <div class="col-md-12">
			<a class="btn btn-default" href="sliders/create" role="button">Create</a>
				...
				<tbody>
					@foreach($list as $item)
						<tr>
							<td> {{ $item->id }} </td>
							<td> {{ $item->title }} </td>
							<td> <img width="10%" src="{{asset('images/sliders/'.$item->image)}}"> </td>
							<td> 
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$(".changeStaus").click(function(e){
			...
			var url_ = "{{Url('/sliders/changeStatus')}}";
