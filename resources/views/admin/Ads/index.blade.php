...
<div class="container">
    <div class="row">
        <div class="col-md-12">
			<a class="btn btn-default" href="admin/Ads/create" role="button">Create</a>
				...
				<tbody>
					@foreach($list as $item)
						<tr>
							<td> {{ $item->id }} </td>
							<td> {{ $item->title }} </td>
							<td> <img width="10%" src="{{asset('uploads/Ads/'.$item->image)}}"> </td>
							<td> 
							...
							<td>
							<a class="btn btn-success" href="Ads/{{ $item->id }}" role="button">show</a>
							<a class="btn btn-primary" href="Ads/{{ $item->id }}/edit" role="button">Edit</a> 
							<a class="btn btn-danger" href="Ads/destroy/{{ $item->id }}" role="button">Delete</a>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$(".changeStaus").click(function(e){
			...
			var url_ = "{{Url('admin/Ads/changeStatus')}}";
