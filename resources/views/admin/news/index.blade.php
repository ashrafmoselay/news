				...
				<tbody>
					@foreach($list as $item)
						<tr>
							...
							<td>
							<a class="btn btn-success" href="news/{{ $item->id }}" role="button">show</a>
							<a class="btn btn-primary" href="news/{{ $item->id }}/edit" role="button">Edit</a> 
							<a class="btn btn-danger" href="news/destroy/{{ $item->id }}" role="button">Delete</a>
